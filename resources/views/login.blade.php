...
<div class="limiter">
    <div class="container-login100">
        <div class="wrap-login100">
            <form action="{{route('connecter')}}" method="post" class="login100-form validate-form">
                @csrf
                ...
                <span class="login100-form-title" style="margin-bottom: 10px;">
						 <img src="{{ asset('front/logoEmaster.png') }}" alt="Logo eMaster" style="width: 150px; height: auto;">
					</span>
                <span class="login100-form-title p-b-26 text-uppercase">
						Distribox PLATEFORME
					</span>


                <div class="wrap-input100 validate-input" data-validate="Entrer votre nom d'utilisateur">
