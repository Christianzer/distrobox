        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            let table = $('#transactions_table').DataTable({
                ...
                ajax: {
                    ...
                    dataSrc: function(json) {
                        ...
                        return json.data.map(function(item) {
                            ...
                            if (transactionMapping[item.transaction]) {
                                item.transaction = transactionMapping[item.transaction];
                            }
                ...
                columns: [
                    ...
                    { data: 'client', name: 'client', searchable: false ,orderable: true},
                ...
                createdRow: function(row, data, dataIndex) {
                    ...
                    // Appliquer des couleurs aux opérateurs
                    let operatorColors = {
                    ...
                    if (operatorColors[data.operateur]) {
                        $('td', row).eq(4).addClass(operatorColors[data.operateur]);
                    }
                },
                language: {
            ...
            $('#filter_type, #filter_operateur').change(function() {
                table.ajax.reload();
            });
            ...
            console.log($('#transactions_table').DataTable().settings());
